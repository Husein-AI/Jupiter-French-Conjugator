...
def get_verbs():
    with open(r"c:\Users\hussein\Desktop\All_Courses\M.Projects\CSA Corporation\All_Verbs.csv") as csv_file:
...
class MainAppScreen(Screen):
    def __init__(self, **kwargs):
        ...
        logo = Image(source='C:\\Users\\hussein\\Desktop\\All_Courses\\M.Projects\\CSA Corporation\\icon.png')
    ...
    def check_time(self, instance):
        ...
        def get_result(line_number):
            with open(r"C:\Users\hussein\Desktop\All_Courses\M.Projects\CSA Corporation\Bac.csv") as csv_file:
                csv_reader = csv.DictReader(csv_file)
                Row= []
                for row in csv_reader:
...
############### Present ###############               
            ...
            if Time == Present:
                ...
                if Verb[-3] == "l" or Verb[:-3] == "L":
                    if pronom == "Je":
                        self.result_label.text = paseo + "èle"
                    elif pronom == "Tu":
                        self.result_label.text = paseo + "èles"
                    elif pronom in ["Il","Elle","On"]:
                        self.result_label.text = paseo + "èle"
                    elif pronom == "Nous":
                        self.result_label.text = pase + "èlons"
                    elif pronom == "Vous":
                        self.result_label.text = pase + "èlez"
                    elif pronom in ["Ils","Elles"]:
                        self.result_label.text = paseo + "èlent"
                    #####
                elif Verb[-3] == "t" or Verb[:-3] == "T":
                    paseo = Verb_ons[:-4]
                    if pronom == "Je":
                        self.result_label.text = paseo + "ète"
                    elif pronom == "Tu":
                        self.result_label.text = paseo + "ètes"
                    elif pronom in ["Il","Elle","On"]:
                        self.result_label.text = paseo + "ète"
                    elif pronom == "Nous":
                        self.result_label.text = pase + "ètons"
                    elif pronom == "Vous":
                        self.result_label.text = pase + "ètez"
                    elif pronom in ["Ils","Elles"]:
                        self.result_label.text = paseo + "ètent" 
###############__Passe_Compose__###############                
            elif Time == P_C:
                pasée = Verb[:-2] + "é"
                if pronom == "Je":
...
###############__6__###############
###############__Present__###############
        if Verb.endswith("er") and not Verb.endswith("eler") and not Verb.endswith("eter") and not Verb.endswith("cer") and not Verb.endswith("yer") and not Verb.endswith("ger"):
            if Time == Present:
                pase = Verb[:-2]
                if pronom == "Je":
                    self.result_label.text = pase + "e"
